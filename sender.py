...
sdr.tx_hardwaregain_chan0 = -30 # Increase for longer distance communication, valid range is between -90 to 0 dB
...
while True:
    ...
    send_message(sdr, "azertyuiopqsdfghjklm".encode(), oversampling, byte_per_control)
